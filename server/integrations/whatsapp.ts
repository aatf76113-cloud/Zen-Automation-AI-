...
export class WhatsAppService {
  ...
  public static getCredentials(orgCredentials?: {
    ...
    const accessToken = (process.env.WHATSAPP_ACCESS_TOKEN || orgCredentials?.accessToken || 'EAAUWVuLU4ukBSpjlPQiapSbCRr7y2ufthH7IniZB5uTslb0tqLSbco53pM4tI5QWVCFqBeZBqCdGAkBe39943xfnw7Ld6Hg37GFm3uCNyX3nUEkEYYRs0ZCwF6bKvZAMEZAufpxGsdRqs38p9ciqf0FkQHZAoke4QXwqlGSZCdGuZA6brdKeYhTYlNTyUtKZCuDCRFQZDZD').trim();
  ...
  public static validateEnvironment(): {
    ...
    const token = process.env.WHATSAPP_ACCESS_TOKEN?.trim() || 'EAAUWVuLU4ukBSpjlPQiapSbCRr7y2ufthH7IniZB5uTslb0tqLSbco53pM4tI5QWVCFqBeZBqCdGAkBe39943xfnw7Ld6Hg37GFm3uCNyX3nUEkEYYRs0ZCwF6bKvZAMEZAufpxGsdRqs38p9ciqf0FkQHZAoke4QXwqlGSZCdGuZA6brdKeYhTYlNTyUtKZCuDCRFQZDZD';
